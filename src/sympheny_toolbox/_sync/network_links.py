# Generated by scripts/generate_sync.py from sympheny_toolbox/_async/network_links.py — do not edit by hand.
...
class NetworkLinks:
    ...
    def update(self, scenario_guid: str, link_guid: str, request: NetworkLinkRequestDtoPUT) -> NetworkLinkResponseDtoV2:
