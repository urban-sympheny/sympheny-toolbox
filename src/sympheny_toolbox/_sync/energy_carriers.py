# Generated by scripts/generate_sync.py from sympheny_toolbox/_async/energy_carriers.py — do not edit by hand.
...
class EnergyCarriers:
    ...
    def update(self, carrier_guid: str, request: EnergyCarrierRequestDtoPUT) -> EnergyCarrierResponseDto:
