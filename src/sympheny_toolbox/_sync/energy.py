# Generated by scripts/generate_sync.py from sympheny_toolbox/_async/energy.py — do not edit by hand.
...
class EnergyCarriers:
    ...
    def create(self, scenario_guid: str, request: EnergyCarrierRequestDtoV2) -> EnergyCarrierResponseDto:
        """Create a new energy carrier in a scenario. ``POST /sympheny-app/v2/scenarios/{scenarioGuid}/carriers``"""
        raw = self._t.request_json("POST", f"/sympheny-app/v2/scenarios/{scenario_guid}/carriers", json=dump(request))
        envelope = ResponseDtoEnergyCarrierResponseDto.model_validate(raw)
        return unwrap(envelope.data)

    def list(self, scenario_guid: str) -> EnergyCarriersListResponseDto:
        """List the energy carriers of a scenario. ``GET /sympheny-app/scenarios/{scenarioGuid}/carriers``"""
        raw = self._t.request_json("GET", f"/sympheny-app/scenarios/{scenario_guid}/carriers")
        envelope = ResponseDtoEnergyCarriersListResponseDto.model_validate(raw)
        return unwrap(envelope.data)

    def get(self, carrier_guid: str) -> EnergyCarrierResponseDto:
        """Get energy carrier details. ``GET /sympheny-app/carriers/{carrierGuid}``"""
        raw = self._t.request_json("GET", f"/sympheny-app/carriers/{carrier_guid}")
        envelope = ResponseDtoEnergyCarrierResponseDto.model_validate(raw)
        return unwrap(envelope.data)

    def update(self, carrier_guid: str, request: EnergyCarrierResponseDto) -> EnergyCarrierResponseDto:
        """Update an energy carrier. ``PUT /sympheny-app/v2/carriers/{carrierGuid}``"""
        raw = self._t.request_json("PUT", f"/sympheny-app/v2/carriers/{carrier_guid}", json=dump(request))
        envelope = ResponseDtoEnergyCarrierResponseDto.model_validate(raw)
        return unwrap(envelope.data)

    def delete(self, carrier_guid: str) -> EnergyCarriersListResponseDto:
        """Delete an energy carrier; returns the remaining carriers. ``DELETE /sympheny-app/scenarios/carriers/{guid}``"""
        raw = self._t.request_json("DELETE", f"/sympheny-app/scenarios/carriers/{carrier_guid}")
        envelope = ResponseDtoEnergyCarriersListResponseDto.model_validate(raw)
        return unwrap(envelope.data)
...
class Impex:
    ...
    def update(self, impex_guid: str, request: ImportExportResponseDtoV2) -> ImportExportResponseDtoV2:
...
class Profiles:
    ...
    def update(self, scenario_guid: str, profile_id: int, request: ProfileDetailsResponseDto) -> ProfileDetailsResponseDto:
...
class EnergyDemands:
    ...
    def update(self, scenario_guid: str, demand_guid: str, request: EnergyDemandResponseDtoV2) -> EnergyDemandResponseDtoV2:
...
class SolarResources:
    ...
    def update(self, resource_guid: str, request: SolarOnSiteResourceResponseDtoV2) -> SolarOnSiteResourceResponseDtoV2:
