...
We are thrilled to announce the release of the latest version of our web application! This release is packed with exciting features and improvements that will enhance your experience and empower you to achieve even more with our platform.

Here are some highlights of what you can expect from this new release:

1. **Enhanced optimization engine**: Sense — energy hub solver engine
