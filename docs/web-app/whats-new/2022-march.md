...
With the SEP add-on for Sympheny, you can get the data you need directly from the embedded GIS map on the web application. SEP provides data from its catalogue directly in Sympheny, including:
...
Sympheny's step 4 Solar Resources is now **On-site Resources**. This means you can integrate hourly energy profiles for any type of On-site Resource candidate — be it *Wind*, *Tidal*, *Process waste heat*, or any other user-defined energy carrier.
