...
1. **Database**: select the database to use — either Sympheny's database or your organization's database. For more information on databases, see [Database Center](../database-center/index.md).
