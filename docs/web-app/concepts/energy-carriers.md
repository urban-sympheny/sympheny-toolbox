...
For parameters, see [Energy carrier parameters](../parameters/energy-carriers.md).

For every stage, hub, energy carrier, and time step, the following energy balance is respected:
