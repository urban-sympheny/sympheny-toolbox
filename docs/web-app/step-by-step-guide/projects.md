...
![Projects page showing a geolocation view of existing projects](img/projects-1.png)
...
![Project actions menu opened from the three-dot button](img/projects-2.png)
...
!!! note
    ...
    someone has it open, and unlocks it automatically after 10 minutes of inactivity. To unlock
    it sooner, choose **Unlock** from the project's three-dot menu on the Projects page.
